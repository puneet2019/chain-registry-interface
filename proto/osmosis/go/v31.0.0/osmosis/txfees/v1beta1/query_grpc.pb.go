...
func (c *queryClient) GetEipBaseFee(ctx context.Context, in *QueryEipBaseFeeRequest, opts ...grpc.CallOption) (*QueryEipBaseFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/osmosis.txfees.v1beta1.Query/GetEipBaseFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) GetEipBaseFee(context.Context, *QueryEipBaseFeeRequest) (*QueryEipBaseFeeResponse, error) {
...
func _Query_GetEipBaseFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.txfees.v1beta1.Query/GetEipBaseFee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
