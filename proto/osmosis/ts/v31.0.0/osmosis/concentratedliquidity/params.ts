...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.authorizedTickSpacing.push(
        ...
        case 7:
          ...
          break;
        case 8:
          message.hookGasLimit = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): Params {
    ...
    message.unrestrictedPoolCreatorWhitelist = [];
    if (
      object.authorizedTickSpacing !== undefined &&
      object.authorizedTickSpacing !== null
    ) {
      for (const e of object.authorizedTickSpacing) {
        message.authorizedTickSpacing.push(Number(e));
      }
    }
    if (
      object.authorizedSpreadFactors !== undefined &&
      object.authorizedSpreadFactors !== null
    ) {
      for (const e of object.authorizedSpreadFactors) {
        message.authorizedSpreadFactors.push(String(e));
      }
    }
    if (
      object.balancerSharesRewardDiscount !== undefined &&
      object.balancerSharesRewardDiscount !== null
    ) {
      message.balancerSharesRewardDiscount = String(
    ...
    if (
      object.authorizedQuoteDenoms !== undefined &&
      object.authorizedQuoteDenoms !== null
    ) {
      for (const e of object.authorizedQuoteDenoms) {
        message.authorizedQuoteDenoms.push(String(e));
      }
    }
    if (
      object.authorizedUptimes !== undefined &&
      object.authorizedUptimes !== null
    ) {
      for (const e of object.authorizedUptimes) {
        message.authorizedUptimes.push(Duration.fromJSON(e));
      }
    }
    if (
      object.isPermissionlessPoolCreationEnabled !== undefined &&
      object.isPermissionlessPoolCreationEnabled !== null
    ) {
      message.isPermissionlessPoolCreationEnabled = Boolean(
    ...
    if (
      object.unrestrictedPoolCreatorWhitelist !== undefined &&
      object.unrestrictedPoolCreatorWhitelist !== null
    ) {
      for (const e of object.unrestrictedPoolCreatorWhitelist) {
        message.unrestrictedPoolCreatorWhitelist.push(String(e));
      }
    }
    if (object.hookGasLimit !== undefined && object.hookGasLimit !== null) {
      message.hookGasLimit = Number(object.hookGasLimit);
    } else {
      message.hookGasLimit = 0;
    }
    return message;
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.authorizedTickSpacing) {
      obj.authorizedTickSpacing = message.authorizedTickSpacing.map((e) => e);
    } else {
      obj.authorizedTickSpacing = [];
    }
    if (message.authorizedSpreadFactors) {
      obj.authorizedSpreadFactors = message.authorizedSpreadFactors.map(
        (e) => e
      );
    } else {
    ...
    if (message.authorizedUptimes) {
      obj.authorizedUptimes = message.authorizedUptimes.map((e) =>
    ...
    message.isPermissionlessPoolCreationEnabled !== undefined &&
      (obj.isPermissionlessPoolCreationEnabled =
        message.isPermissionlessPoolCreationEnabled);
    if (message.unrestrictedPoolCreatorWhitelist) {
      obj.unrestrictedPoolCreatorWhitelist = message.unrestrictedPoolCreatorWhitelist.map(
        (e) => e
      );
    } else {
      obj.unrestrictedPoolCreatorWhitelist = [];
    }
    message.hookGasLimit !== undefined &&
      (obj.hookGasLimit = message.hookGasLimit);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (
      ...
      for (const e of object.authorizedTickSpacing) {
        message.authorizedTickSpacing.push(e);
      }
    }
    if (
      object.authorizedSpreadFactors !== undefined &&
      ...
      for (const e of object.authorizedSpreadFactors) {
        message.authorizedSpreadFactors.push(e);
      }
    }
    if (
      object.balancerSharesRewardDiscount !== undefined &&
    ...
    if (
      ...
      for (const e of object.authorizedQuoteDenoms) {
        message.authorizedQuoteDenoms.push(e);
      }
    }
    if (
      object.authorizedUptimes !== undefined &&
      ...
      for (const e of object.authorizedUptimes) {
        message.authorizedUptimes.push(Duration.fromPartial(e));
      }
    }
    if (
      object.isPermissionlessPoolCreationEnabled !== undefined &&
    ...
    if (
      ...
      for (const e of object.unrestrictedPoolCreatorWhitelist) {
        message.unrestrictedPoolCreatorWhitelist.push(e);
      }
    }
    if (object.hookGasLimit !== undefined && object.hookGasLimit !== null) {
      message.hookGasLimit = object.hookGasLimit;
    } else {
      message.hookGasLimit = 0;
    }
    return message;
