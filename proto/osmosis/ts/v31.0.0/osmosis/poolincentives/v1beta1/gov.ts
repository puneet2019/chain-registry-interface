...
import { DistrRecord } from "../../../osmosis/poolincentives/v1beta1/incentives";
...
const baseReplacePoolIncentivesProposal: object = {
  title: "",
  description: "",
};
...
export const ReplacePoolIncentivesProposal = {
  ...
  decode(
    ...
    const message = {
      ...baseReplacePoolIncentivesProposal,
    } as ReplacePoolIncentivesProposal;
    message.records = [];
  ...
  fromPartial(
    object: DeepPartial<ReplacePoolIncentivesProposal>
  ): ReplacePoolIncentivesProposal {
    const message = {
      ...baseReplacePoolIncentivesProposal,
    } as ReplacePoolIncentivesProposal;
...
export const UpdatePoolIncentivesProposal = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpdatePoolIncentivesProposal,
    } as UpdatePoolIncentivesProposal;
    message.records = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<UpdatePoolIncentivesProposal>
  ): UpdatePoolIncentivesProposal {
    const message = {
      ...baseUpdatePoolIncentivesProposal,
    } as UpdatePoolIncentivesProposal;
