...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("osmosis.poolmanager.v2.Query", "SpotPriceV2"));
...
pub mod query_server {
                ...
                "/osmosis.poolmanager.v2.Query/SpotPriceV2" => {
                    ...
                    for SpotPriceV2Svc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Query>::spot_price_v2(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = SpotPriceV2Svc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "osmosis.poolmanager.v2.Query";
