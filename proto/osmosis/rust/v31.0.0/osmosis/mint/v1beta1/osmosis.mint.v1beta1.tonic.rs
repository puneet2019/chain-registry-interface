...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("osmosis.mint.v1beta1.Query", "Params"));
        ...
        pub async fn epoch_provisions(
            ...
            tonic::Response<super::QueryEpochProvisionsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("osmosis.mint.v1beta1.Query", "EpochProvisions"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("osmosis.mint.v1beta1.Query", "Inflation"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/osmosis.mint.v1beta1.Query/EpochProvisions" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryEpochProvisionsRequest>
                    for EpochProvisionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::epoch_provisions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "osmosis.mint.v1beta1.Query";
