...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn params(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("feemarket.feemarket.v1.Query", "Params"));
        ...
        pub async fn state(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("feemarket.feemarket.v1.Query", "State"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn gas_price(
            &mut self,
            request: impl tonic::IntoRequest<super::GasPriceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GasPriceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("feemarket.feemarket.v1.Query", "GasPrice"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("feemarket.feemarket.v1.Query", "GasPrices"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
    ...
    pub trait Query: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn gas_price(
            &self,
            request: tonic::Request<super::GasPriceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GasPriceResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/feemarket.feemarket.v1.Query/State" => {
                    #[allow(non_camel_case_types)]
                    struct StateSvc<T: Query>(pub Arc<T>);
                    impl<T: Query> tonic::server::UnaryService<super::StateRequest>
                    for StateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::state(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/feemarket.feemarket.v1.Query/GasPrice" => {
                    #[allow(non_camel_case_types)]
                    struct GasPriceSvc<T: Query>(pub Arc<T>);
                    impl<T: Query> tonic::server::UnaryService<super::GasPriceRequest>
                    for GasPriceSvc<T> {
                        type Response = super::GasPriceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::gas_price(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/feemarket.feemarket.v1.Query/GasPrices" => {
                    #[allow(non_camel_case_types)]
                    struct GasPricesSvc<T: Query>(pub Arc<T>);
                    impl<T: Query> tonic::server::UnaryService<super::GasPricesRequest>
                    for GasPricesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::gas_prices(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "feemarket.feemarket.v1.Query";
