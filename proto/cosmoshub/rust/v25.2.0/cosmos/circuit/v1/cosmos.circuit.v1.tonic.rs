...
pub mod query_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/cosmos.circuit.v1.Query/DisabledList" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryDisabledListRequest>
                    for DisabledListSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::disabled_list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "cosmos.circuit.v1.Query";
