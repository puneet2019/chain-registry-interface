...
pub struct ValidatorSetChangePacketData {
    ...
    pub validator_updates: ::prost::alloc::vec::Vec<super::super::super::tendermint::abci::ValidatorUpdate>,
    #[prost(uint64, tag = "2")]
...
pub struct SlashPacketData {
    ...
    #[prost(enumeration = "super::super::super::cosmos::staking::v1beta1::Infraction", tag = "3")]
    pub infraction: i32,
}
