...
func (UnimplementedQueryServer) CodeInfo(context.Context, *QueryCodeInfoRequest) (*QueryCodeInfoResponse, error) {
...
func (UnimplementedQueryServer) WasmLimitsConfig(context.Context, *QueryWasmLimitsConfigRequest) (*QueryWasmLimitsConfigResponse, error) {
