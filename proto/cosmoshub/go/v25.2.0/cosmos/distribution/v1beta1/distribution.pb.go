...
func (x *ValidatorHistoricalRewards) GetCumulativeRewardRatio() []*types.DecCoin {
	if x != nil {
...
func (x *ValidatorCurrentRewards) GetRewards() []*types.DecCoin {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *ValidatorAccumulatedCommission) GetCommission() []*types.DecCoin {
	if x != nil {
		return x.Commission
	}
	return nil
...
func (x *ValidatorOutstandingRewards) GetRewards() []*types.DecCoin {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *FeePool) GetCommunityPool() []*types.DecCoin {
	if x != nil {
...
func (x *CommunityPoolSpendProposal) GetAmount() []*types.Coin {
	if x != nil {
		return x.Amount
	}
	return nil
...
func (x *DelegationDelegatorReward) GetReward() []*types.DecCoin {
	if x != nil {
		return x.Reward
	}
	return nil
...
var file_cosmos_distribution_v1beta1_distribution_proto_rawDesc = []byte{
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x37,
