...
func (x *SignatureDescriptor_Data_Multi) GetBitarray() *types.CompactBitArray {
	if x != nil {
		return x.Bitarray
	}
	return nil
...
var file_cosmos_tx_signing_v1beta1_signing_proto_rawDesc = []byte{
	...
	0x31, 0x39, 0x31, 0x10, 0xbf, 0x01, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_cosmos_tx_signing_v1beta1_signing_proto_goTypes = []interface{}{
	...
	(*types.CompactBitArray)(nil),           // 7: cosmos.crypto.multisig.v1beta1.CompactBitArray
}
