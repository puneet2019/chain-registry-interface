...
func (x *BasicAllowance) GetSpendLimit() []*types.Coin {
	if x != nil {
		return x.SpendLimit
	}
	return nil
...
func (x *PeriodicAllowance) GetPeriodSpendLimit() []*types.Coin {
	if x != nil {
...
func (x *PeriodicAllowance) GetPeriodCanSpend() []*types.Coin {
	if x != nil {
...
var file_cosmos_feegrant_v1beta1_feegrant_proto_rawDesc = []byte{
	...
	0x77, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x19, 0x5a, 0x17, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73,
