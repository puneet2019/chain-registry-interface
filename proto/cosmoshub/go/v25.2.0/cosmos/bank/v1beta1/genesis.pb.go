...
func (x *GenesisState) GetSupply() []*types.Coin {
	if x != nil {
		return x.Supply
	}
	return nil
...
func (x *Balance) GetCoins() []*types.Coin {
	if x != nil {
		return x.Coins
	}
	return nil
...
var file_cosmos_bank_v1beta1_genesis_proto_rawDesc = []byte{
	...
	0xe8, 0xa0, 0x1f, 0x00, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
