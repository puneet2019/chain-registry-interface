...
export const ConfigResponse = {
  ...
  fromJSON(object: any): ConfigResponse {
    const message = { ...baseConfigResponse } as ConfigResponse;
    if (
      object.minimumGasPrice !== undefined &&
      object.minimumGasPrice !== null
    ) {
    ...
    if (
      ...
      message.pruningKeepRecent = String(object.pruningKeepRecent);
    } else {
      message.pruningKeepRecent = "";
    }
    if (
      object.pruningInterval !== undefined &&
      object.pruningInterval !== null
    ) {
      message.pruningInterval = String(object.pruningInterval);
    } else {
      message.pruningInterval = "";
    }
    if (object.haltHeight !== undefined && object.haltHeight !== null) {
      message.haltHeight = Number(object.haltHeight);
    } else {
      message.haltHeight = 0;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<ConfigResponse>): ConfigResponse {
    ...
    if (object.haltHeight !== undefined && object.haltHeight !== null) {
      message.haltHeight = object.haltHeight;
    } else {
      message.haltHeight = 0;
    }
    return message;
...
const baseStatusResponse: object = { earliestStoreHeight: 0, height: 0 };
...
export const StatusResponse = {
  ...
  fromJSON(object: any): StatusResponse {
    ...
    if (
      ...
      message.earliestStoreHeight = Number(object.earliestStoreHeight);
    } else {
      message.earliestStoreHeight = 0;
    }
    ...
    if (object.validatorHash !== undefined && object.validatorHash !== null) {
      message.validatorHash = bytesFromBase64(object.validatorHash);
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<StatusResponse>): StatusResponse {
    ...
    if (
      ...
      message.earliestStoreHeight = object.earliestStoreHeight;
    } else {
      message.earliestStoreHeight = 0;
    }
    if (object.height !== undefined && object.height !== null) {
    ...
    if (object.validatorHash !== undefined && object.validatorHash !== null) {
      message.validatorHash = object.validatorHash;
    } else {
      message.validatorHash = new Uint8Array();
    }
    return message;
