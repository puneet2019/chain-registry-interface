...
export const QueryAllBalancesRequest = {
  ...
  fromJSON(object: any): QueryAllBalancesRequest {
    ...
    if (object.resolveDenom !== undefined && object.resolveDenom !== null) {
      message.resolveDenom = Boolean(object.resolveDenom);
    } else {
  ...
  fromPartial(
    ...
    if (object.resolveDenom !== undefined && object.resolveDenom !== null) {
      message.resolveDenom = object.resolveDenom;
    } else {
      message.resolveDenom = false;
    }
    return message;
...
export class QueryClientImpl implements Query {
  ...
  DenomMetadataByQueryString(
    ...
    const data = QueryDenomMetadataByQueryStringRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "cosmos.bank.v1beta1.Query",
