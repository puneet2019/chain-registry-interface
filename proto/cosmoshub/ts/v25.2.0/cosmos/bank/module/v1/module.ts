...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    message.restrictionsOrder = [];
    if (
      object.blockedModuleAccountsOverride !== undefined &&
      object.blockedModuleAccountsOverride !== null
    ) {
      for (const e of object.blockedModuleAccountsOverride) {
        message.blockedModuleAccountsOverride.push(String(e));
      }
    }
    ...
    if (
      object.restrictionsOrder !== undefined &&
      object.restrictionsOrder !== null
    ) {
      for (const e of object.restrictionsOrder) {
        message.restrictionsOrder.push(String(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: Module): unknown {
    ...
    if (message.blockedModuleAccountsOverride) {
      obj.blockedModuleAccountsOverride = message.blockedModuleAccountsOverride.map(
        (e) => e
      );
    } else {
  ...
  fromPartial(object: DeepPartial<Module>): Module {
    ...
    if (
      ...
      for (const e of object.blockedModuleAccountsOverride) {
        message.blockedModuleAccountsOverride.push(e);
      }
    }
    if (object.authority !== undefined && object.authority !== null) {
    ...
    if (
      ...
      for (const e of object.restrictionsOrder) {
        message.restrictionsOrder.push(e);
      }
    }
    return message;
  },
