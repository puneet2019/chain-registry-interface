...
const baseTxBody: object = { memo: "", timeoutHeight: 0, unordered: false };
...
export const TxBody = {
  encode(
    ...
    if (message.timeoutTimestamp !== undefined) {
      Timestamp.encode(
        toTimestamp(message.timeoutTimestamp),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.timeoutTimestamp = fromTimestamp(
  ...
  fromJSON(object: any): TxBody {
    ...
    if (object.unordered !== undefined && object.unordered !== null) {
      message.unordered = Boolean(object.unordered);
    } else {
      message.unordered = false;
    }
    if (
      object.timeoutTimestamp !== undefined &&
      object.timeoutTimestamp !== null
    ) {
      message.timeoutTimestamp = fromJsonTimestamp(object.timeoutTimestamp);
    } else {
