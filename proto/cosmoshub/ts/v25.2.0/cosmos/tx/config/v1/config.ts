...
export const Config = {
  ...
  fromJSON(object: any): Config {
    const message = { ...baseConfig } as Config;
    if (
      object.skipAnteHandler !== undefined &&
      object.skipAnteHandler !== null
    ) {
      message.skipAnteHandler = Boolean(object.skipAnteHandler);
    } else {
      message.skipAnteHandler = false;
    }
    if (
      object.skipPostHandler !== undefined &&
      object.skipPostHandler !== null
    ) {
      message.skipPostHandler = Boolean(object.skipPostHandler);
    } else {
      message.skipPostHandler = false;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<Config>): Config {
    ...
    if (
      ...
      message.skipAnteHandler = object.skipAnteHandler;
    } else {
      message.skipAnteHandler = false;
    }
    if (
      ...
      message.skipPostHandler = object.skipPostHandler;
    } else {
      message.skipPostHandler = false;
    }
    return message;
