...
import { Permissions } from "../../../cosmos/circuit/v1/types";
...
export const MsgTripCircuitBreaker = {
  ...
  fromJSON(object: any): MsgTripCircuitBreaker {
    ...
    if (object.msgTypeUrls !== undefined && object.msgTypeUrls !== null) {
      for (const e of object.msgTypeUrls) {
        message.msgTypeUrls.push(String(e));
      }
    }
    return message;
  },
