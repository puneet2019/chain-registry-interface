...
export const AccountResponse = {
  ...
  fromJSON(object: any): AccountResponse {
    ...
    if (object.permission !== undefined && object.permission !== null) {
      message.permission = Permissions.fromJSON(object.permission);
    } else {
...
export const AccountsResponse = {
  ...
  fromJSON(object: any): AccountsResponse {
    ...
    if (object.accounts !== undefined && object.accounts !== null) {
      for (const e of object.accounts) {
        message.accounts.push(GenesisAccountPermissions.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
  ...
  fromPartial(object: DeepPartial<AccountsResponse>): AccountsResponse {
    ...
    if (object.accounts !== undefined && object.accounts !== null) {
      for (const e of object.accounts) {
        message.accounts.push(GenesisAccountPermissions.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
...
export const DisabledListResponse = {
  ...
  fromJSON(object: any): DisabledListResponse {
    const message = { ...baseDisabledListResponse } as DisabledListResponse;
    message.disabledList = [];
    if (object.disabledList !== undefined && object.disabledList !== null) {
      for (const e of object.disabledList) {
        message.disabledList.push(String(e));
      }
    }
    return message;
  },
