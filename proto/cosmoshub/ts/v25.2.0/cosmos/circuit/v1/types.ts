...
export const Permissions = {
  ...
  fromJSON(object: any): Permissions {
    ...
    if (object.limitTypeUrls !== undefined && object.limitTypeUrls !== null) {
      for (const e of object.limitTypeUrls) {
        message.limitTypeUrls.push(String(e));
      }
    }
    return message;
  },
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.disabledTypeUrls = [];
    if (
      object.accountPermissions !== undefined &&
      object.accountPermissions !== null
    ) {
      for (const e of object.accountPermissions) {
        message.accountPermissions.push(GenesisAccountPermissions.fromJSON(e));
      }
    }
    if (
      object.disabledTypeUrls !== undefined &&
      object.disabledTypeUrls !== null
    ) {
      for (const e of object.disabledTypeUrls) {
        message.disabledTypeUrls.push(String(e));
      }
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      for (const e of object.disabledTypeUrls) {
        message.disabledTypeUrls.push(e);
      }
    }
    return message;
  },
