...
const baseModule: object = { feeCollectorName: "", authority: "" };
...
export const Module = {
  ...
  fromJSON(object: any): Module {
    const message = { ...baseModule } as Module;
    if (
      object.feeCollectorName !== undefined &&
      object.feeCollectorName !== null
    ) {
      message.feeCollectorName = String(object.feeCollectorName);
    } else {
      message.feeCollectorName = "";
    }
