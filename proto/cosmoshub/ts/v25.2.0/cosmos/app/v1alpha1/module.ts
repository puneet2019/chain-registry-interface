...
export const ModuleDescriptor = {
  ...
  fromJSON(object: any): ModuleDescriptor {
    ...
    if (object.usePackage !== undefined && object.usePackage !== null) {
      for (const e of object.usePackage) {
        message.usePackage.push(PackageReference.fromJSON(e));
      }
    }
    if (object.canMigrateFrom !== undefined && object.canMigrateFrom !== null) {
      for (const e of object.canMigrateFrom) {
        message.canMigrateFrom.push(MigrateFromInfo.fromJSON(e));
      }
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<ModuleDescriptor>): ModuleDescriptor {
    ...
    if (object.usePackage !== undefined && object.usePackage !== null) {
      for (const e of object.usePackage) {
        message.usePackage.push(PackageReference.fromPartial(e));
      }
    }
    if (object.canMigrateFrom !== undefined && object.canMigrateFrom !== null) {
      for (const e of object.canMigrateFrom) {
        message.canMigrateFrom.push(MigrateFromInfo.fromPartial(e));
      }
    }
    return message;
  },
