...
export const BlockMetadata = {
  ...
  fromJSON(object: any): BlockMetadata {
    ...
    if (
      ...
      message.requestFinalizeBlock = RequestFinalizeBlock.fromJSON(
        object.requestFinalizeBlock
      );
    } else {
  ...
  fromPartial(object: DeepPartial<BlockMetadata>): BlockMetadata {
    const message = { ...baseBlockMetadata } as BlockMetadata;
    if (object.responseCommit !== undefined && object.responseCommit !== null) {
      message.responseCommit = ResponseCommit.fromPartial(
        object.responseCommit
      );
    } else {
      message.responseCommit = undefined;
    }
    if (
      ...
      message.requestFinalizeBlock = RequestFinalizeBlock.fromPartial(
        object.requestFinalizeBlock
      );
    } else {
      message.requestFinalizeBlock = undefined;
