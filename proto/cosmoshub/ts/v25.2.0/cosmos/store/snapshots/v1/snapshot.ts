...
export const SnapshotItem = {
  ...
  fromJSON(object: any): SnapshotItem {
    ...
    if (
      object.extensionPayload !== undefined &&
      object.extensionPayload !== null
    ) {
      message.extensionPayload = SnapshotExtensionPayload.fromJSON(
  ...
  fromPartial(object: DeepPartial<SnapshotItem>): SnapshotItem {
    ...
    if (
      ...
      message.extensionPayload = SnapshotExtensionPayload.fromPartial(
        object.extensionPayload
      );
    } else {
      message.extensionPayload = undefined;
...
export const SnapshotExtensionMeta = {
  ...
  fromPartial(
    object: DeepPartial<SnapshotExtensionMeta>
  ): SnapshotExtensionMeta {
    const message = { ...baseSnapshotExtensionMeta } as SnapshotExtensionMeta;
    if (object.name !== undefined && object.name !== null) {
      message.name = object.name;
...
export const SnapshotExtensionPayload = {
  ...
  fromPartial(
    object: DeepPartial<SnapshotExtensionPayload>
  ): SnapshotExtensionPayload {
    const message = {
      ...baseSnapshotExtensionPayload,
    } as SnapshotExtensionPayload;
