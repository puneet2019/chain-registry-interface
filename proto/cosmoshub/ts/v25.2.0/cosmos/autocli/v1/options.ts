...
const baseServiceCommandDescriptor: object = {
  service: "",
...
export const ServiceCommandDescriptor = {
  ...
  fromJSON(object: any): ServiceCommandDescriptor {
    ...
    if (
      object.rpcCommandOptions !== undefined &&
      object.rpcCommandOptions !== null
    ) {
    ...
    if (
      object.enhanceCustomCommand !== undefined &&
      object.enhanceCustomCommand !== null
    ) {
      message.enhanceCustomCommand = Boolean(object.enhanceCustomCommand);
    } else {
  ...
  toJSON(message: ServiceCommandDescriptor): unknown {
    ...
    message.enhanceCustomCommand !== undefined &&
  ...
  fromPartial(
    ...
    if (object.subCommands !== undefined && object.subCommands !== null) {
      Object.entries(object.subCommands).forEach(([key, value]) => {
        if (value !== undefined) {
          message.subCommands[key] = ServiceCommandDescriptor.fromPartial(
            value
          );
        }
      });
    ...
    if (
      ...
      message.enhanceCustomCommand = object.enhanceCustomCommand;
    } else {
      message.enhanceCustomCommand = false;
    }
    if (object.short !== undefined && object.short !== null) {
...
export const RpcCommandOptions = {
  ...
  fromJSON(object: any): RpcCommandOptions {
    ...
    if (object.govProposal !== undefined && object.govProposal !== null) {
      message.govProposal = Boolean(object.govProposal);
    } else {
      message.govProposal = false;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<RpcCommandOptions>): RpcCommandOptions {
    ...
    if (object.govProposal !== undefined && object.govProposal !== null) {
      message.govProposal = object.govProposal;
    } else {
      message.govProposal = false;
    }
    return message;
...
const basePositionalArgDescriptor: object = {
  protoField: "",
  varargs: false,
  optional: false,
};
