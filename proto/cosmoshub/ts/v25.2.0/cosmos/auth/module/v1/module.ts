...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    if (
      object.moduleAccountPermissions !== undefined &&
      object.moduleAccountPermissions !== null
    ) {
      for (const e of object.moduleAccountPermissions) {
        message.moduleAccountPermissions.push(
    ...
    if (
      object.enableUnorderedTransactions !== undefined &&
      object.enableUnorderedTransactions !== null
    ) {
      message.enableUnorderedTransactions = Boolean(
        object.enableUnorderedTransactions
      );
    } else {
      message.enableUnorderedTransactions = false;
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<Module>): Module {
    ...
    if (
      ...
      message.enableUnorderedTransactions = object.enableUnorderedTransactions;
    } else {
      message.enableUnorderedTransactions = false;
    }
    return message;
