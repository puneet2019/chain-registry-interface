...
const baseEventProposalPruned: object = { proposalId: 0, status: 0 };
...
export const EventProposalPruned = {
  ...
  fromJSON(object: any): EventProposalPruned {
    ...
    if (object.tallyResult !== undefined && object.tallyResult !== null) {
      message.tallyResult = TallyResult.fromJSON(object.tallyResult);
    } else {
...
const baseEventTallyError: object = { proposalId: 0, errorMessage: "" };
