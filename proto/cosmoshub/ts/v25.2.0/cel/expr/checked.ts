...
import { SourceInfo, Expr, Constant } from "../../cel/expr/syntax";
  ...
  fromJSON(object: any): CheckedExpr {
    ...
    if (object.referenceMap !== undefined && object.referenceMap !== null) {
      Object.entries(object.referenceMap).forEach(([key, value]) => {
        message.referenceMap[Number(key)] = Reference.fromJSON(value);
      });
    }
    if (object.typeMap !== undefined && object.typeMap !== null) {
      Object.entries(object.typeMap).forEach(([key, value]) => {
        message.typeMap[Number(key)] = Type.fromJSON(value);
      });
    }
...
export const CheckedExpr_ReferenceMapEntry = {
  ...
  fromJSON(object: any): CheckedExpr_ReferenceMapEntry {
    ...
    if (object.value !== undefined && object.value !== null) {
      message.value = Reference.fromJSON(object.value);
    } else {
...
export const CheckedExpr_TypeMapEntry = {
  ...
  fromJSON(object: any): CheckedExpr_TypeMapEntry {
    ...
    if (object.value !== undefined && object.value !== null) {
      message.value = Type.fromJSON(object.value);
    } else {
      message.value = undefined;
    }
    return message;
...
export const Type = {
  ...
  fromJSON(object: any): Type {
    ...
    if (object.dyn !== undefined && object.dyn !== null) {
      message.dyn = Empty.fromJSON(object.dyn);
    } else {
    ...
    if (object.wellKnown !== undefined && object.wellKnown !== null) {
      message.wellKnown = type_WellKnownTypeFromJSON(object.wellKnown);
    } else {
      message.wellKnown = undefined;
    }
    if (object.listType !== undefined && object.listType !== null) {
      message.listType = Type_ListType.fromJSON(object.listType);
    } else {
      message.listType = undefined;
    }
    if (object.mapType !== undefined && object.mapType !== null) {
      message.mapType = Type_MapType.fromJSON(object.mapType);
    } else {
      message.mapType = undefined;
    }
    if (object.function !== undefined && object.function !== null) {
      message.function = Type_FunctionType.fromJSON(object.function);
    } else {
    ...
    if (object.error !== undefined && object.error !== null) {
      message.error = Empty.fromJSON(object.error);
    } else {
      message.error = undefined;
    }
    if (object.abstractType !== undefined && object.abstractType !== null) {
      message.abstractType = Type_AbstractType.fromJSON(object.abstractType);
    } else {
  ...
  toJSON(message: Type): unknown {
    ...
    message.null !== undefined &&
      (obj.null =
        message.null !== undefined ? nullValueToJSON(message.null) : undefined);
    message.primitive !== undefined &&
      (obj.primitive =
        message.primitive !== undefined
          ? type_PrimitiveTypeToJSON(message.primitive)
          : undefined);
    message.wrapper !== undefined &&
      (obj.wrapper =
        message.wrapper !== undefined
          ? type_PrimitiveTypeToJSON(message.wrapper)
          : undefined);
    message.wellKnown !== undefined &&
      (obj.wellKnown =
        message.wellKnown !== undefined
          ? type_WellKnownTypeToJSON(message.wellKnown)
          : undefined);
    message.listType !== undefined &&
      (obj.listType = message.listType
        ? Type_ListType.toJSON(message.listType)
        : undefined);
    message.mapType !== undefined &&
      (obj.mapType = message.mapType
        ? Type_MapType.toJSON(message.mapType)
        : undefined);
    message.function !== undefined &&
      (obj.function = message.function
        ? Type_FunctionType.toJSON(message.function)
        : undefined);
    message.messageType !== undefined &&
    ...
    message.error !== undefined &&
      (obj.error = message.error ? Empty.toJSON(message.error) : undefined);
    message.abstractType !== undefined &&
      (obj.abstractType = message.abstractType
        ? Type_AbstractType.toJSON(message.abstractType)
        : undefined);
    return obj;
  },
...
export const Type_ListType = {
  ...
  fromJSON(object: any): Type_ListType {
    ...
    if (object.elemType !== undefined && object.elemType !== null) {
      message.elemType = Type.fromJSON(object.elemType);
    } else {
...
export const Type_MapType = {
  ...
  fromJSON(object: any): Type_MapType {
    ...
    if (object.keyType !== undefined && object.keyType !== null) {
      message.keyType = Type.fromJSON(object.keyType);
    } else {
      message.keyType = undefined;
    }
    if (object.valueType !== undefined && object.valueType !== null) {
      message.valueType = Type.fromJSON(object.valueType);
    } else {
  ...
  fromJSON(object: any): Type_AbstractType {
    ...
    if (object.parameterTypes !== undefined && object.parameterTypes !== null) {
      for (const e of object.parameterTypes) {
        message.parameterTypes.push(Type.fromJSON(e));
      }
    }
    return message;
  },
...
export const Decl = {
  ...
  fromJSON(object: any): Decl {
    ...
    if (object.ident !== undefined && object.ident !== null) {
      message.ident = Decl_IdentDecl.fromJSON(object.ident);
    } else {
      message.ident = undefined;
    }
    if (object.function !== undefined && object.function !== null) {
      message.function = Decl_FunctionDecl.fromJSON(object.function);
    } else {
      message.function = undefined;
    }
    return message;
  ...
  toJSON(message: Decl): unknown {
    ...
    message.name !== undefined && (obj.name = message.name);
    message.ident !== undefined &&
      (obj.ident = message.ident
        ? Decl_IdentDecl.toJSON(message.ident)
        : undefined);
    message.function !== undefined &&
      (obj.function = message.function
        ? Decl_FunctionDecl.toJSON(message.function)
        : undefined);
    return obj;
  },
...
export const Decl_IdentDecl = {
  ...
  fromJSON(object: any): Decl_IdentDecl {
    ...
    if (object.value !== undefined && object.value !== null) {
      message.value = Constant.fromJSON(object.value);
    } else {
      message.value = undefined;
    }
  ...
  fromJSON(object: any): Decl_FunctionDecl {
    ...
    if (object.overloads !== undefined && object.overloads !== null) {
      for (const e of object.overloads) {
        message.overloads.push(Decl_FunctionDecl_Overload.fromJSON(e));
      }
    }
    return message;
  },
...
export const Decl_FunctionDecl_Overload = {
  ...
  fromJSON(object: any): Decl_FunctionDecl_Overload {
    ...
    if (
      ...
      message.isInstanceFunction = Boolean(object.isInstanceFunction);
    } else {
  ...
  fromJSON(object: any): Reference {
    ...
    if (object.overloadId !== undefined && object.overloadId !== null) {
      for (const e of object.overloadId) {
        message.overloadId.push(String(e));
      }
    }
    if (object.value !== undefined && object.value !== null) {
      message.value = Constant.fromJSON(object.value);
