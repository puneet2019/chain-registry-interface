...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      ...
      message.controllerGenesisState = ControllerGenesisState.fromJSON(
        object.controllerGenesisState
      );
    } else {
      message.controllerGenesisState = undefined;
    }
    if (
      object.hostGenesisState !== undefined &&
      object.hostGenesisState !== null
    ) {
      message.hostGenesisState = HostGenesisState.fromJSON(
        object.hostGenesisState
      );
    } else {
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      message.controllerGenesisState = ControllerGenesisState.fromPartial(
        object.controllerGenesisState
      );
    } else {
      message.controllerGenesisState = undefined;
    ...
    if (
      ...
      message.hostGenesisState = HostGenesisState.fromPartial(
        object.hostGenesisState
      );
    } else {
      message.hostGenesisState = undefined;
...
export const ControllerGenesisState = {
  ...
  fromJSON(object: any): ControllerGenesisState {
    ...
    if (
      object.interchainAccounts !== undefined &&
      object.interchainAccounts !== null
    ) {
...
export const ActiveChannel = {
  ...
  fromJSON(object: any): ActiveChannel {
    ...
    if (
      ...
      message.isMiddlewareEnabled = Boolean(object.isMiddlewareEnabled);
    } else {
  ...
  fromPartial(object: DeepPartial<ActiveChannel>): ActiveChannel {
    ...
    if (
      ...
      message.isMiddlewareEnabled = object.isMiddlewareEnabled;
    } else {
      message.isMiddlewareEnabled = false;
    }
    return message;
