...
export const Allocation = {
  ...
  fromJSON(object: any): Allocation {
    ...
    if (
      object.allowedPacketData !== undefined &&
      object.allowedPacketData !== null
    ) {
      for (const e of object.allowedPacketData) {
        message.allowedPacketData.push(String(e));
      }
    }
    return message;
  },
  ...
  fromPartial(object: DeepPartial<Allocation>): Allocation {
    ...
    if (
      ...
      for (const e of object.allowedPacketData) {
        message.allowedPacketData.push(e);
      }
    }
    return message;
  },
