...
const baseClientState: object = { sequence: 0, isFrozen: false };
...
export const ClientState = {
  ...
  fromJSON(object: any): ClientState {
    ...
    if (object.isFrozen !== undefined && object.isFrozen !== null) {
  ...
  fromPartial(object: DeepPartial<ClientState>): ClientState {
    ...
    if (object.isFrozen !== undefined && object.isFrozen !== null) {
      message.isFrozen = object.isFrozen;
    } else {
      message.isFrozen = false;
    }
    if (object.consensusState !== undefined && object.consensusState !== null) {
...
const baseConsensusState: object = { diversifier: "", timestamp: 0 };
...
const baseHeader: object = { timestamp: 0, newDiversifier: "" };
...
const baseMisbehaviour: object = { sequence: 0 };
...
const baseSignatureAndData: object = { timestamp: 0 };
...
const baseTimestampedSignatureData: object = { timestamp: 0 };
...
const baseSignBytes: object = { sequence: 0, timestamp: 0, diversifier: "" };
