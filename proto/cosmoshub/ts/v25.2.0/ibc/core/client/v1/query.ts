...
import { MerklePath } from "../../../../ibc/core/commitment/v2/commitment";
...
const baseQueryClientCreatorRequest: object = { clientId: "" };
...
export const QueryClientCreatorRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryClientCreatorRequest,
    } as QueryClientCreatorRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryClientCreatorRequest>
  ): QueryClientCreatorRequest {
    const message = {
      ...baseQueryClientCreatorRequest,
    } as QueryClientCreatorRequest;
...
const baseQueryClientCreatorResponse: object = { creator: "" };
...
export const QueryClientCreatorResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryClientCreatorResponse,
    } as QueryClientCreatorResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryClientCreatorResponse>
  ): QueryClientCreatorResponse {
    const message = {
      ...baseQueryClientCreatorResponse,
    } as QueryClientCreatorResponse;
...
const baseQueryVerifyMembershipRequest: object = {
  clientId: "",
  timeDelay: 0,
  blockDelay: 0,
};
...
export const QueryVerifyMembershipRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryVerifyMembershipRequest,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.timeDelay = longToNumber(reader.uint64() as Long);
          break;
        case 7:
  ...
  fromJSON(object: any): QueryVerifyMembershipRequest {
    ...
    if (object.timeDelay !== undefined && object.timeDelay !== null) {
      message.timeDelay = Number(object.timeDelay);
    } else {
      message.timeDelay = 0;
    }
    if (object.blockDelay !== undefined && object.blockDelay !== null) {
      message.blockDelay = Number(object.blockDelay);
    } else {
      message.blockDelay = 0;
    }
    if (object.merklePath !== undefined && object.merklePath !== null) {
      message.merklePath = MerklePath.fromJSON(object.merklePath);
    } else {
  ...
  fromPartial(
    object: DeepPartial<QueryVerifyMembershipRequest>
  ): QueryVerifyMembershipRequest {
    const message = {
      ...baseQueryVerifyMembershipRequest,
    } as QueryVerifyMembershipRequest;
    ...
    if (object.blockDelay !== undefined && object.blockDelay !== null) {
      message.blockDelay = object.blockDelay;
    } else {
      message.blockDelay = 0;
    }
    if (object.merklePath !== undefined && object.merklePath !== null) {
...
const baseQueryVerifyMembershipResponse: object = { success: false };
...
export const QueryVerifyMembershipResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryVerifyMembershipResponse,
  ...
  fromPartial(
    object: DeepPartial<QueryVerifyMembershipResponse>
  ): QueryVerifyMembershipResponse {
    const message = {
      ...baseQueryVerifyMembershipResponse,
    } as QueryVerifyMembershipResponse;
...
export class QueryClientImpl implements Query {
  ...
  ClientCreator(
    ...
    return promise.then((data) =>
      QueryClientCreatorResponse.decode(new _m0.Reader(data))
    );
  }
