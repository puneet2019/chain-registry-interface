...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.inFlightPackets = {};
    if (
      object.inFlightPackets !== undefined &&
      object.inFlightPackets !== null
    ) {
...
export const GenesisState_InFlightPacketsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseGenesisState_InFlightPacketsEntry,
    } as GenesisState_InFlightPacketsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<GenesisState_InFlightPacketsEntry>
  ): GenesisState_InFlightPacketsEntry {
    const message = {
      ...baseGenesisState_InFlightPacketsEntry,
    } as GenesisState_InFlightPacketsEntry;
...
export const InFlightPacket = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.packetTimeoutTimestamp = longToNumber(
  ...
  fromJSON(object: any): InFlightPacket {
    ...
    message.packetData = new Uint8Array();
    if (
      object.originalSenderAddress !== undefined &&
      object.originalSenderAddress !== null
    ) {
    ...
    if (
      object.refundChannelId !== undefined &&
      object.refundChannelId !== null
    ) {
    ...
    if (
      object.packetSrcChannelId !== undefined &&
      object.packetSrcChannelId !== null
    ) {
    ...
    if (
      object.packetSrcPortId !== undefined &&
      object.packetSrcPortId !== null
    ) {
    ...
    if (
      object.packetTimeoutTimestamp !== undefined &&
      object.packetTimeoutTimestamp !== null
    ) {
      message.packetTimeoutTimestamp = Number(object.packetTimeoutTimestamp);
    } else {
      message.packetTimeoutTimestamp = 0;
    }
    if (
      object.packetTimeoutHeight !== undefined &&
      object.packetTimeoutHeight !== null
    ) {
    ...
    if (object.refundSequence !== undefined && object.refundSequence !== null) {
      message.refundSequence = Number(object.refundSequence);
    } else {
      message.refundSequence = 0;
    }
    if (
      object.retriesRemaining !== undefined &&
      object.retriesRemaining !== null
    ) {
  ...
  toJSON(message: InFlightPacket): unknown {
    ...
    message.refundPortId !== undefined &&
      (obj.refundPortId = message.refundPortId);
    message.packetSrcChannelId !== undefined &&
      (obj.packetSrcChannelId = message.packetSrcChannelId);
    message.packetSrcPortId !== undefined &&
    ...
    message.packetTimeoutHeight !== undefined &&
    ...
    message.retriesRemaining !== undefined &&
      (obj.retriesRemaining = message.retriesRemaining);
