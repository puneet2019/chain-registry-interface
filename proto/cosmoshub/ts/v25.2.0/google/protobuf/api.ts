...
export const Method = {
  ...
  fromJSON(object: any): Method {
    ...
    if (
      object.requestStreaming !== undefined &&
      object.requestStreaming !== null
    ) {
    ...
    if (
      object.responseTypeUrl !== undefined &&
      object.responseTypeUrl !== null
    ) {
    ...
    if (
      object.responseStreaming !== undefined &&
      object.responseStreaming !== null
    ) {
  ...
  toJSON(message: Method): unknown {
    ...
    message.requestStreaming !== undefined &&
      (obj.requestStreaming = message.requestStreaming);
    message.responseTypeUrl !== undefined &&
      (obj.responseTypeUrl = message.responseTypeUrl);
    message.responseStreaming !== undefined &&
