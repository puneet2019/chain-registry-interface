...
export function codeGeneratorResponse_FeatureFromJSON(
  object: any
...
export function codeGeneratorResponse_FeatureToJSON(
  object: CodeGeneratorResponse_Feature
): string {
  switch (object) {
...
export const CodeGeneratorRequest = {
  ...
  fromJSON(object: any): CodeGeneratorRequest {
    ...
    if (
      object.compilerVersion !== undefined &&
  ...
  toJSON(message: CodeGeneratorRequest): unknown {
    ...
    if (message.protoFile) {
      obj.protoFile = message.protoFile.map((e) =>
    ...
    message.compilerVersion !== undefined &&
      (obj.compilerVersion = message.compilerVersion
        ? Version.toJSON(message.compilerVersion)
        : undefined);
    return obj;
  },
...
export const CodeGeneratorResponse = {
  ...
  fromJSON(object: any): CodeGeneratorResponse {
    ...
    if (
      object.supportedFeatures !== undefined &&
  ...
  toJSON(message: CodeGeneratorResponse): unknown {
    ...
    if (message.file) {
      obj.file = message.file.map((e) =>
        e ? CodeGeneratorResponse_File.toJSON(e) : undefined
      );
    } else {
      obj.file = [];
    }
  ...
  fromPartial(
    object: DeepPartial<CodeGeneratorResponse>
  ): CodeGeneratorResponse {
    const message = { ...baseCodeGeneratorResponse } as CodeGeneratorResponse;
    message.file = [];
    if (object.error !== undefined && object.error !== null) {
...
const baseCodeGeneratorResponse_File: object = {
  name: "",
  insertionPoint: "",
  content: "",
};
...
export const CodeGeneratorResponse_File = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCodeGeneratorResponse_File,
  ...
  fromJSON(object: any): CodeGeneratorResponse_File {
    ...
    if (
      object.generatedCodeInfo !== undefined &&
      object.generatedCodeInfo !== null
    ) {
      message.generatedCodeInfo = GeneratedCodeInfo.fromJSON(
  ...
  toJSON(message: CodeGeneratorResponse_File): unknown {
    ...
    message.insertionPoint !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<CodeGeneratorResponse_File>
  ): CodeGeneratorResponse_File {
    const message = {
      ...baseCodeGeneratorResponse_File,
    } as CodeGeneratorResponse_File;
    ...
    if (
      ...
      message.generatedCodeInfo = GeneratedCodeInfo.fromPartial(
        object.generatedCodeInfo
      );
    } else {
      message.generatedCodeInfo = undefined;
