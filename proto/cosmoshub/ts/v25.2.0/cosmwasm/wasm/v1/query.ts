...
const baseQueryCodeInfoResponse: object = { codeId: 0, creator: "" };
...
const baseQueryContractsByCreatorRequest: object = { creatorAddress: "" };
...
const baseQueryContractsByCreatorResponse: object = { contractAddresses: "" };
...
export const QueryContractsByCreatorResponse = {
  ...
  fromJSON(object: any): QueryContractsByCreatorResponse {
    ...
    message.contractAddresses = [];
    if (
      object.contractAddresses !== undefined &&
      object.contractAddresses !== null
    ) {
...
const baseQueryWasmLimitsConfigRequest: object = {};

export const QueryWasmLimitsConfigRequest = {
  encode(
    _: QueryWasmLimitsConfigRequest,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryWasmLimitsConfigRequest,
    } as QueryWasmLimitsConfigRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryWasmLimitsConfigRequest>
  ): QueryWasmLimitsConfigRequest {
    const message = {
      ...baseQueryWasmLimitsConfigRequest,
    } as QueryWasmLimitsConfigRequest;
...
const baseQueryWasmLimitsConfigResponse: object = { config: "" };
...
export const QueryWasmLimitsConfigResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryWasmLimitsConfigResponse,
    } as QueryWasmLimitsConfigResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryWasmLimitsConfigResponse>
  ): QueryWasmLimitsConfigResponse {
    const message = {
      ...baseQueryWasmLimitsConfigResponse,
    } as QueryWasmLimitsConfigResponse;
...
const baseQueryBuildAddressRequest: object = {
  codeHash: "",
  creatorAddress: "",
  salt: "",
};
...
export const QueryBuildAddressRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryBuildAddressRequest,
    } as QueryBuildAddressRequest;
    message.initArgs = new Uint8Array();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryBuildAddressRequest {
    ...
    if (object.initArgs !== undefined && object.initArgs !== null) {
      message.initArgs = bytesFromBase64(object.initArgs);
    }
    return message;
  },
  ...
  toJSON(message: QueryBuildAddressRequest): unknown {
    ...
    message.initArgs !== undefined &&
      (obj.initArgs = base64FromBytes(
        message.initArgs !== undefined ? message.initArgs : new Uint8Array()
      ));
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryBuildAddressRequest>
  ): QueryBuildAddressRequest {
    const message = {
      ...baseQueryBuildAddressRequest,
    } as QueryBuildAddressRequest;
    ...
    if (object.initArgs !== undefined && object.initArgs !== null) {
      message.initArgs = object.initArgs;
    } else {
      message.initArgs = new Uint8Array();
    }
    return message;
...
const baseQueryBuildAddressResponse: object = { address: "" };
...
export const QueryBuildAddressResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryBuildAddressResponse>
  ): QueryBuildAddressResponse {
    const message = {
      ...baseQueryBuildAddressResponse,
    } as QueryBuildAddressResponse;
...
export class QueryClientImpl implements Query {
  ...
  CodeInfo(request: QueryCodeInfoRequest): Promise<QueryCodeInfoResponse> {
    ...
    return promise.then((data) =>
      QueryCodeInfoResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ContractsByCreator(
    ...
    return promise.then((data) =>
      QueryContractsByCreatorResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  WasmLimitsConfig(
    ...
    return promise.then((data) =>
      QueryWasmLimitsConfigResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  BuildAddress(
    ...
    return promise.then((data) =>
      QueryBuildAddressResponse.decode(new _m0.Reader(data))
    );
  }
}
