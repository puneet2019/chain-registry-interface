...
const baseStoreCodeAuthorization: object = {};
...
export const StoreCodeAuthorization = {
  ...
  decode(
    ...
    const message = { ...baseStoreCodeAuthorization } as StoreCodeAuthorization;
    message.grants = [];
  ...
  fromJSON(object: any): StoreCodeAuthorization {
    ...
    if (object.grants !== undefined && object.grants !== null) {
      for (const e of object.grants) {
        message.grants.push(CodeGrant.fromJSON(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: StoreCodeAuthorization): unknown {
    ...
    if (message.grants) {
      obj.grants = message.grants.map((e) =>
        e ? CodeGrant.toJSON(e) : undefined
      );
    } else {
      obj.grants = [];
    }
  ...
  fromPartial(
    object: DeepPartial<StoreCodeAuthorization>
  ): StoreCodeAuthorization {
    const message = { ...baseStoreCodeAuthorization } as StoreCodeAuthorization;
    message.grants = [];
    if (object.grants !== undefined && object.grants !== null) {
      for (const e of object.grants) {
        message.grants.push(CodeGrant.fromPartial(e));
      }
    }
    return message;
  },
...
export const CodeGrant = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CodeGrant {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseCodeGrant } as CodeGrant;
...
const baseCombinedLimit: object = { callsRemaining: 0 };
...
export const CombinedLimit = {
  ...
  fromJSON(object: any): CombinedLimit {
    ...
    if (object.callsRemaining !== undefined && object.callsRemaining !== null) {
      message.callsRemaining = Number(object.callsRemaining);
    } else {
